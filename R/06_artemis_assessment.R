...
if (!exists("artemisResult")) {
  ...
  writeResultCsv(stack("summary"),  "artemis_summary", "artemis")
  writeResultCsv(stack("coverage"), "artemis_coverage", "artemis")
  writeResultCsv(stack("drug"),     "artemis_drug_exposures", "artemis")
  writeResultCsv(stack("reg"),      "artemis_regimens_aligned", "artemis")
  writeResultCsv(stack("perPat"),   "artemis_episodes_per_patient", "artemis")
  writeResultCsv(stack("uncap"),    "artemis_uncaptured_drugs", "artemis")
